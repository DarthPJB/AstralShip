...
// when facing this surface, the right-most edge
...
module Rafters(Origin = [-1935,0,2365])
{
    ...
    translate(Origin)
    {
        ...
        // Central Pillar Beam
        SquareBeam([0,0,0], [0,0,-2365], Pillar_Width, Pillar_Depth, false, true);
        ...
        translate([-Pillar_Width / 2,Pillar_Depth/2, Ceilng_To_Beam_Base])
        {
        ...
        translate([-Pillar_Width,0, Ceilng_To_Beam_Base])
        {
            //Beam to workshop exterior entrance
